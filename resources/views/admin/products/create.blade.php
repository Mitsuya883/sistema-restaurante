        ...
        <div class="bg-white dark:bg-dark-eval-1 rounded-2xl shadow-md border border-gray-100 dark:border-gray-700 overflow-hidden">
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" class="p-6 md:p-8">
                ...
                <div class="mb-8 p-4 bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800 rounded-xl flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-bold text-red-700 dark:text-red-400 text-sm">Por favor revisa los campos:</h4>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="name" required placeholder="Ej: Lomo Saltado"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input type="number" step="0.10" name="price" required placeholder="0.00"
                                    class="w-full pl-10 py-3 text-sm border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-dark-eval-2 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 transition-all shadow-sm placeholder-gray-400">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <textarea name="description" rows="4" placeholder="Describe los ingredientes principales..."
                                class="w-full pl-10 py-3 text-sm border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-dark-eval-2 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 transition-all shadow-sm resize-none"></textarea>
                        </div>
                    </div>
